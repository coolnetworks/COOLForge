...
$ScreenConnectBaseUrl = "{{policy_screenconnect_baseurl}}"
<#
.SYNOPSIS
    Slim Level.io Launcher for ScreenConnect Device URL extraction

.DESCRIPTION
    Extracts the ScreenConnect GUID from registry and constructs the device URL.
    Outputs the URL in Level.io custom field format to populate cf_screenconnect_device_url.
