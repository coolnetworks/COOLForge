...
# ============================================================
$ScriptToRun = "👀acrobat-pro.ps1"
$policy_acrobat_pro = "{{cf_policy_acrobat_pro}}"
<#
.SYNOPSIS
    Slim Level.io Script Launcher - Downloads library, then delegates to Invoke-ScriptLauncher.

.NOTES
    Launcher Version: 2026.03.26.01
...
$LauncherVersion = "2026.03.26.01"
$LauncherName = "Policy/👀acrobat-pro.ps1"
