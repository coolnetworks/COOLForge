...
# ============================================================
$ScriptToRun = "👀level-monitor.ps1"
$policy_level_monitor = "{{cf_policy_level_monitor}}"
$policy_level_monitor_webhook = "{{cf_policy_level_monitor_webhook}}"
$policy_level_monitor_interval = "{{cf_policy_level_monitor_interval}}"
<#
.SYNOPSIS
    Slim Level.io Script Launcher - Downloads library, then delegates to Invoke-ScriptLauncher.

.NOTES
    Launcher Version: 2026.03.17.01
...
$LauncherVersion = "2026.03.17.01"
$LauncherName = "Policy/👀level-monitor.ps1"
