...
# ============================================================
$ScriptToRun = "⚙️Set WiFi SSID.ps1"
$policy_wifi_setup = "{{cf_policy_wifi_setup}}"
$policy_wifi_ssid = "{{cf_policy_wifi_ssid}}"
$policy_wifi_ssid_password = "{{cf_policy_wifi_ssid_password}}"
<#
.SYNOPSIS
    Slim Level.io Script Launcher - Downloads library, then delegates to Invoke-ScriptLauncher.

.NOTES
    Launcher Version: 2026.03.18.03
