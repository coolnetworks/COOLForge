...
.DESCRIPTION
    This script resets all Windows 8.1 services to their Microsoft-recommended default
    ...
    The script sets each service's startup type to the Windows 8.1 default:
...
.NOTES
    ...
    Based on Windows 8.1 default service configuration.
...
Write-Host "[*] Windows 8.1 detected (Build $BuildNumber)"
