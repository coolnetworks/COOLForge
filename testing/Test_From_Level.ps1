...
Write-Host ""
Write-Host "========================================"
Write-Host "COOLForge-Common Library Test Suite"
...
try {
    ...
    $ModuleContent = Get-Content -Path $LibraryPath -Raw; New-Module -Name "COOLForge-Common" -ScriptBlock ([scriptblock]::Create($ModuleContent)) | Import-Module -Force
